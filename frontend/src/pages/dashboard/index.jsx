...
const [isLiking, setIsLiking] = useState({});
        ...
        <div className={styles.scrollComponent}>
            ...
            <div className={styles.wrapper}>
              ...
              <div className={styles.createPostContainer}>
                ...
                placeholder={"What's in Your mind"} name="" id=""></textarea>
  ...
  >
    ...
    <span style={{ color: colors.text }}>
      {post.likes}
              ...
              <div onClick={openModal} className={styles.single_optionContainer}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        onClick={()=>{
          ...
          {postState.comments.length !==0 && 
           <div>
            {postState.comments.comments.map((comment,index)=>{
  ...
  const isAuthor = comment.userId._id === authState.user.userId._id;
              ...
              return(
                <div
      className={styles.single_comment}
      key={comment._id}
      onMouseEnter={() => {
